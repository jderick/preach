...
// extern "C" long sysconf(int name);   // added by Uli
extern "C" long int sysconf(int name) throw();   
// SPARK: gcc 3.1 throws different exceptions  <unistd.h>
...
enum live_type { E, AE, EA, U, AIE, AIU, C };
struct liverec {
  char *name;
