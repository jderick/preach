...
#ifdef ERLANG
void state::Exhaustive_Fast_Canonicalize()
{
  static SymmetryClass symmetry;

  symmetry.Exhaustive_Fast_Canonicalize(this);
}
void state::Heuristic_Fast_Canonicalize()
{
  static SymmetryClass symmetry;

  symmetry.Heuristic_Fast_Canonicalize(this);
}
#endif
